...
--
-- Table structure for table `hkm_brand`
--

DROP TABLE IF EXISTS `hkm_brand`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hkm_brand` (
...
--
-- Dumping data for table `hkm_brand`
--

LOCK TABLES `hkm_brand` WRITE;
/*!40000 ALTER TABLE `hkm_brand` DISABLE KEYS */;
/*!40000 ALTER TABLE `hkm_brand` ENABLE KEYS */;
UNLOCK TABLES;
