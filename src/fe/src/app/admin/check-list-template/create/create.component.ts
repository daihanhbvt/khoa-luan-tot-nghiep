...
@Component({
    selector: 'create-check-list-template',
    templateUrl: 'create.component.html',
    styleUrls: ['create.component.scss']
})

export class CreateCheckListTemplateComponent implements OnInit {
    constructor(
        private service: CheckListTemplateService,
        public dialogRef: MatDialogRef<CreateCheckListTemplateComponent>,
