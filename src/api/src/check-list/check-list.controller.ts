...
export class CheckListController {
  ...
  async all(@Req() req: Request, @Query() query: Pagination) {
    const result = await this.checkListService.findAll(
      req,
  ...
  async get(@Req() req: Request, @Param('id') id: string) {
    const result = await this.checkListService.get(req, id);
    return result instanceof Problem ? Problem.HttpException(result) : result;
  }
  ...
  async create(
    @Req() req: Request,
    @Body() body: ReqCheckList,
  ): Promise<CheckList | Problem> {
    const result = this.checkListService.create(req, body);
    return result instanceof Problem ? Problem.HttpException(result) : result;
  }
  ...
  async update(
    ...
    const result = this.checkListService.update(req, id, body);
    return result instanceof Problem ? Problem.HttpException(result) : result;
  }

  @Delete('delete/:id')
  async delete(@Req() req: Request, @Param('id') id: string): Promise<any> {
    const result = this.checkListService.delete(req, id);
    return result instanceof Problem ? Problem.HttpException(result) : result;
  }
}
